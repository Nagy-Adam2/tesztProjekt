...
abstract class MessagesControllerDe implements IPageBase
{
    //put your code here
    #[\Override]
    public static function Run(?\Template $template = null): void
    {
        try
        {
            ...
            for($i = 0; $i < count(Model::GetText("Recipes-and-messages-de")); $i++) {
                ...
                $template->AddData("MESSAGES", $classMarginBottomTwo . $paragraphClassTextPrimaryBegin . Model::GetText("Recipes-and-messages-de")[$i]["Message"]["body"] . $paragraphClassTextPrimaryEnd . $divEnd);
                $messageUrl = Model::GetText("Recipes-and-messages-de")[$i]["Message"]["url"];
                ...
                $template->AddData("MESSAGES", $divEnd);
                $template->AddData("MESSAGES", $cardFooterDivBegin. Model::GetText("Recipes-and-messages-de")[$i]["Message"]["userMessage"] . $divEnd);
                $template->AddData("MESSAGES", $divEnd);
            }

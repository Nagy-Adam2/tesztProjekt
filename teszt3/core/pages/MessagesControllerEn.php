...
abstract class MessagesControllerEn implements IPageBase
{
    //put your code here
    #[\Override]
        ...
        try
        {
            $template->AddData("NAVIGATION", 
                '<div class="container-fluid">
                    <a class="navbar-brand" href="?p=imagesen">Food of our</a>
                    ...
                    <div class="justify-content-end collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-4">
                            <li class="nav-item mx-1">
                                <a class="nav-link" aria-current="index" href="?p=imagesen">Food of recipes</a>
                            </li>
                            <li class="nav-item mx-1">
                                <a class="nav-link" href="?p=messagesen">Messages</a>
                            </li>
                        </ul>
                        <ul class="navbar-nav navbar-nav-row mx-4">
                                <li class="nav-item item-inline-flex px-2">
                                    <a class="nav-link" 
                                    href="?p=messages">HU</a>
                                </li>
                                <li class="nav-item item-inline-flex px-2">
                                    <a class="nav-link" 
                                    href="?p=messagesen">EN</a>
                                </li>
                                <li class="nav-item item-inline-flex px-2">
                                    <a class="nav-link" 
                                    href="?p=messagesde">GE</a>
                                </li>
                            </ul>
                    </div>
                </div>'
            ...
            $divEnd = '</div>';
            for($i = 0; $i < count(Model::GetText("Recipes-and-messages-en")); $i++) {
                $template->AddData("MESSAGES", $cardDivBegin);
                $imageTitle = Model::GetText("Recipes-and-messages-en")[$i]["title"];
                ...
                $template->AddData("MESSAGES", $classMarginBottomTwo . $paragraphClassTextPrimaryBegin . Model::GetText("Recipes-and-messages-en")[$i]["Message"]["body"] . $paragraphClassTextPrimaryEnd . $divEnd);
                $messageUrl = Model::GetText("Recipes-and-messages-en")[$i]["Message"]["url"];
                ...
                $imagePath = Model::GetText("Recipes-and-messages-en")[$i]["Message"]["imagePath"];
                ...
                $template->AddData("MESSAGES", $divEnd);
                $template->AddData("MESSAGES", $cardFooterDivBegin. Model::GetText("Recipes-and-messages-en")[$i]["Message"]["userMessage"] . $divEnd);
                $template->AddData("MESSAGES", $divEnd);
            }
